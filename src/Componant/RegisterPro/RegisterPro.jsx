...
export default function RegisterPro() {
  ...
  function validate(value) {
    ...
    if (!value.phone) {
      ...
      /^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$/.test(value.phone)
    ) {
    ...
    onSubmit: async function (values) {
      try {
        ...
        const { data } = await axios
          ...
          .catch((erroe) => {
            setahmed(
              `  ${erroe.response.data.errors.msg} ${erroe.response.data.message}`
            );
          });
        ...
        <div className="row">
          <div className=" col-12  col-md-6 col-3 col-sm-6  col-xl-12  m-auto my-2">
            <form onSubmit={formik.handleSubmit}>
              <div className="alerty"> {ahmed ? ahmed : ""}</div>
              ...
              <div className="d-flex">
                ...
                {spnnerregister == true ? (
                  <div
                    class="spinner-border text-primary me-2 mt-3"
                    role="status"
                  >
